...
const lessons = [
  ...
  function calculatePercentage(secondsOfTeacher,...totalSeconds) {
  ...
  function totalDuration() {
    ...
    return `
      Kurs Opanuj JavaScript trwa ${calculateTime(sumaAdama+sumaPrzemka+sumaMarcina)[0]} godzin i ${calculateTime(sumaAdama+sumaPrzemka+sumaMarcina)[1]} minut.
      Moduł Adama: ${calculateTime(sumaAdama)[0]} godzin ${calculateTime(sumaAdama)[1]} minut i jest to ${calculatePercentage(sumaAdama, sumaAdama, sumaPrzemka, sumaMarcina)} kursu
      Moduł Przemka: ${calculateTime(sumaPrzemka)[0]} godzin ${calculateTime(sumaPrzemka)[1]} minut i jest to ${calculatePercentage(sumaPrzemka, sumaAdama, sumaPrzemka, sumaMarcina)} kursu
      Moduł Marcina: ${calculateTime(sumaMarcina)[0]} godzin ${calculateTime(sumaMarcina)[1]} minut i jest to ${calculatePercentage(sumaMarcina, sumaAdama, sumaPrzemka, sumaMarcina)} kursu
  `;
  }
