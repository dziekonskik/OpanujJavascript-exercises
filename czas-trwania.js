...
https://repl.it/@jaseveen/Czas-trwania             !!!!!! <<=== Live Preview
*/
...
function totalDuration() {
  ...
  lessons.forEach((lesson) => {
    ...
    const modulPrzemka =
      Object.values(lesson)[0] > modulAdama && Object.values(lesson)[0] < 47;
  ...
  return `
      Kurs Opanuj JavaScript trwa ${
        calculateTime(sumaAdama + sumaPrzemka + sumaMarcina)[0]
      } godzin i ${
    calculateTime(sumaAdama + sumaPrzemka + sumaMarcina)[1]
  } minut.
      Moduł Adama: ${calculateTime(sumaAdama)[0]} godzin ${
    calculateTime(sumaAdama)[1]
  } minut i jest to ${calculatePercentage(
    sumaAdama,
    sumaAdama,
    sumaPrzemka,
    sumaMarcina
  )} kursu
      Moduł Przemka: ${calculateTime(sumaPrzemka)[0]} godzin ${
    calculateTime(sumaPrzemka)[1]
  } minut i jest to ${calculatePercentage(
    sumaPrzemka,
    sumaAdama,
    sumaPrzemka,
    sumaMarcina
      ...
      Moduł Marcina: ${calculateTime(sumaMarcina)[0]} godzin ${
    calculateTime(sumaMarcina)[1]
  } minut i jest to ${calculatePercentage(
    sumaMarcina,
    sumaAdama,
    sumaPrzemka,
